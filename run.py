...
df4 = getRows("BAHIA DEL DIABLO", data)
##df4.to_csv('book1.csv')


import example_text_client

if __name__ == "__main__":
    example_text_client.ez_auth()
    ourData = example_text_client.ez_predict()
    print(ourData)
    spec_data = ourData['predictions']['data']
    ##print(spec_data)
    ##spec_data_1 = spec_data[0]
    ##print(spec_data_1)
    #spec_data_1 = spec_data_1[0]
    spec_data = spec_data[0]
    data_1 = spec_data[13]
    print(data_1)

our_data = {'RESULT': [data_1]}
df2 = pd.DataFrame(our_data, columns = ['RESULT'])
